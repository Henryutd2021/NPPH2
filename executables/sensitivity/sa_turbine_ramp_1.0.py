#!/usr/bin/env python3
"""
Sensitivity Analysis Script for Turbine Ramp Rate = 1.0
This script tests the optimization framework with Turbine ramp rate set to 1.0 (both up and down)
"""
...
def setup_logging():
    ...
    log_filename = os.path.join(
        OUTPUT_DIR, f"turbine_ramp_1.0_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
    logging.basicConfig(
        level=logging.INFO,
    ...
    logging.info("=== Turbine Ramp Rate 1.0 Sensitivity Analysis Started ===")
...
def run_optimization():
    ...
    try:
        ...
        results_filename = os.path.join(
            OUTPUT_DIR, "turbine_ramp_1.0_results.csv")
        summary_filename = os.path.join(
            OUTPUT_DIR, "turbine_ramp_1.0_summary.json")
...
def main():
    ...
    try:
        ...
        logging.info(
            "=== Turbine Ramp Rate 1.0 Sensitivity Analysis Completed ===")
        return 0
