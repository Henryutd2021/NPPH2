...
sys.path.append(os.path.abspath(os.path.join(
    os.path.dirname(__file__), "../..", "src")))  # Go up two levels to project root


# --- Configuration ---
BASE_INPUT_DIR = "../../input/hourly_data"  # Updated path for new location
BASE_SYS_DATA_FILE = os.path.join(BASE_INPUT_DIR, "sys_data_advanced.csv")
SENSITIVITY_OUTPUT_DIR = "../../output/sa"  # Updated path for new location
