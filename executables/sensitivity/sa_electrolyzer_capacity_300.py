#!/usr/bin/env python3
"""
Sensitivity Analysis Script for Electrolyzer Capacity = 300MW
This script tests the optimization framework with Electrolyzer capacity upper bound set to 300MW
"""
...
OUTPUT_DIR = "../output/sensitivity_analysis/electrolyzer_capacity_300"
TEMP_DIR = "../temp_sensitivity_runs/electrolyzer_capacity_300"

# Parameters to modify
ELECTROLYZER_CAPACITY_MW = 300.0
...
def setup_logging():
    ...
    log_filename = os.path.join(OUTPUT_DIR, "electrolyzer_capacity_300.log")
    logging.basicConfig(
        level=logging.INFO,
    ...
    logging.info(
        "=== Electrolyzer Capacity 300MW Sensitivity Analysis Started ===")
...
def run_optimization():
    ...
    try:
        ...
        results_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_300_results.csv")
        summary_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_300_summary.json")
...
def main():
    ...
    try:
        ...
        logging.info(
            "=== Electrolyzer Capacity 300MW Sensitivity Analysis Completed ===")
        return 0
