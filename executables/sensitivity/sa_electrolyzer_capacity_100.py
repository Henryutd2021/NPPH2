#!/usr/bin/env python3
"""
Sensitivity Analysis Script for Electrolyzer Capacity = 100MW
...
OUTPUT_DIR = "../../output/sensitivity_analysis/electrolyzer_capacity_100"
TEMP_DIR = "../../temp_sensitivity_runs/electrolyzer_capacity_100"
...
def setup_logging():
    ...
    logging.info(
        "=== Electrolyzer Capacity 100MW Sensitivity Analysis Started ===")
...
def run_optimization():
    ...
    try:
        ...
        results_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_100_results.csv")
        summary_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_100_summary.json")
...
def main():
    ...
    try:
        ...
        logging.info(
            "=== Electrolyzer Capacity 100MW Sensitivity Analysis Completed ===")
        return 0
