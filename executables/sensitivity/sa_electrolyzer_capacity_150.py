#!/usr/bin/env python3
"""
Sensitivity Analysis Script for Electrolyzer Capacity = 150MW
This script tests the optimization framework with Electrolyzer capacity upper bound set to 150MW
"""
...
OUTPUT_DIR = "../../output/sensitivity_analysis/electrolyzer_capacity_150"
TEMP_DIR = "../../temp_sensitivity_runs/electrolyzer_capacity_150"

# Parameters to modify
ELECTROLYZER_CAPACITY_MW = 150.0
...
def setup_logging():
    ...
    log_filename = os.path.join(OUTPUT_DIR, "electrolyzer_capacity_150.log")
    logging.basicConfig(
        level=logging.INFO,
    ...
    logging.info(
        "=== Electrolyzer Capacity 150MW Sensitivity Analysis Started ===")
...
def run_optimization():
    ...
    try:
        ...
        results_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_150_results.csv")
        summary_filename = os.path.join(
            OUTPUT_DIR, "electrolyzer_capacity_150_summary.json")
...
def main():
    ...
    try:
        ...
        logging.info(
            "=== Electrolyzer Capacity 150MW Sensitivity Analysis Completed ===")
        return 0
